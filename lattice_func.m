%SIRD model
function lattice_func (days2, infection_rate2, infection_radius2, ...
infection_factor2, mask_probability2, elderly_proportion2, vaccination_rate2, ...
vaccination_threshold2, exportcontour, exportgraph, exportcorr, legendon, ...
yaxislim, cname, gname, corrname)
...
infection_rate=infection_rate2; %the rate that each additional neighbor multiplies the infection probability by
...
mask_probability=mask_probability2;
mask_effectiveness=.8; %how much of the time it prevents infection

elderly_proportion=elderly_proportion2; %reflects current statistics for the world
...
vaccination_rate=vaccination_rate2; %proportion of susceptible population vaccinated on a given day
...
vaccination_threshold=vaccination_threshold2; %proportion of people I/R/D before vaccination starts
